        ...
        <div class="product-details py-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <img v-if="item" :src="item.imgUrl" alt="chair" class="img-fluid itemImg">
                    </div>
                    <div class="col-lg-5">
                        ...
                        <div class="color" v-if="item.colors">
                            <span v-for="color in item.colors" :key="color.id" :style="{ background: color.color }"
                                :class="{ active: color.active }" @click="handleColorChange(color.color, color.id)">
                            </span>
                        </div>
                        ...
                        <div class="quantity">
                            ...
                            <a href="#" class="qtyButton" @click.stop.prevent="handleQtyChange(true)">
