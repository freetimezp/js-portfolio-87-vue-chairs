...
<template>
    <div class="card">
        ...
        <div class="contentBox">
            ...
            <div class="color">
                <h3>Color:</h3>
                <span v-for="color in item.colors" :key="color.id" :style="{ background: color.color }"></span>
            </div>

            <div class="pricing">
                <span class="price" :style="[item.discount !== 0
                    && { textDecoration: 'line-through', textDecorationColor: 'red', fontSize: '1rem' }]">
